...
object JvmFlags {
    ...
    fun getClassFlags(isAllInterfaceBodiesInside: Boolean, isCompatibility: Boolean): Int =
        ARE_INTERFACE_METHOD_BODIES_INSIDE.toFlags(isAllInterfaceBodiesInside) or IS_ALL_COMPATIBILITY_MODE.toFlags(isCompatibility)
